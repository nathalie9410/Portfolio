...
Le processus de recueil, transformation, analyse des données pour en tirer des recommandations exploitables sous la forme de visualisations ou de dashboards n'a plus de secrets pour moi.
''')
...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background-color: #16A2CB;">
  <a class="navbar-brand" href="www.linkedin.com/in/nathalie-claude-mqe" target="_blank">Nathalie CLAUDE</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#work-experience">Expérience professionnelle</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#bioinformatics-tools">Soft Skills</a>
      </li>
      <li class="nav-item">
      <li class="nav-item">
        <a class="nav-link" href="#bioinformatics-tools">Réalisations Personnelles</a>
      </li>
      <li class="nav-item">
